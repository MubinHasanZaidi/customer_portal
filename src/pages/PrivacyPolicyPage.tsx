      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-5 text-sm mb-2">
            ...
            <li>
              Usage Data: Portal System activity, job searches, messages, and
              communication logs.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-5 text-sm mb-2">
            <li>
              We employ standard encryption, firewall protection, and secure
              servers in line with SECP’s cybersecurity framework to protect
              user data from breaches or unauthorized access.
            </li>
            <li>
            ...
            <ul className="list-disc pl-10 text-sm mb-2">
              <li>
                Protect data from unauthorized access, alteration, disclosure,
                or destruction.
              </li>
        ...
        <section className="mb-6">
          ...
          <p className="text-sm mb-2">
            We retain personal data only as long as necessary for recruitment
          ...
          <p className="text-sm mb-2">
            If you wish to have your data deleted or modified, please contact{" "}
            {/* {company?.email || ""}. */}
          </p>
        </section>
        <section className="mb-6">
        ...
        <section className="mb-6">
          ...
          <p className="text-sm mb-2">
            This portal may use cookies to enhance the user experience. Users
            may choose to set their web browser to refuse cookies or alert when
